...
const LastCardHolder = () => {
  return (
    <>
        ...
        <div className="border border-slate-400 grid grid-cols-1 gap-5 justify-center items-center">
                <div>
                ...
                <div className='flex flex-col gap-3 justify-start items-start p-3'>
                    ...
                    <button className='bg-cyan-400 text-white border border-cyan-500 px-4 py-1 hover:bg-white hover:text-black transition-all duration-300 mb-4 mt-4'>Go somowhere</button>
                </div>
            </div>
            <div className="border border-slate-400 grid grid-cols-1 gap-5 justify-center items-center">
                <div>
