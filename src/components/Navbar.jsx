...
const Navbar = () => {
  return (
    <>
        <div className="navbar flex justify-between gap-2 items-center px-8 md:px-10 lg:px-[110px] shadow-md pb-5">
            <div className='items-center mt-5'>
                <h1 className='text-xl font-bold'>CoHost</h1>
            </div>
            <div className='flex lg:gap-10 gap-2 items-center justify-center uppercase mt-5'>
